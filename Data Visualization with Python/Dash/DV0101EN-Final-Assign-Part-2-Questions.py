...
def update_output_container(dropdown_statistics, year):
    if dropdown_statistics == 'Recession Period Statistics':
        ...
        R_chart1 = dcc.Graph(
            figure=px.line(yearly_rec,
                           x='Year',
                           y='Automobile_Sales',
                           title="Recessions periods automobile sales over year"))
        ...
        R_chart2 = dcc.Graph(
            figure=px.bar(average_sales,
                          x='Vehicle_Type',
                          y='Automobile_Sales',
                          title="Mean of automobile sales over type of vehicle"))


        # Plot 3 : Pie chart for total expenditure share by vehicle type during recessions
        # grouping data for plotting
        # Hint:Use Vehicle_Type and Advertising_Expenditure columns
        exp_rec = recession_data.groupby('Vehicle_Type').sum('Advertising_Expenditure').reset_index()
        R_chart3 = dcc.Graph(
            figure=px.pie(exp_rec,
                          values='Advertising_Expenditure',
                          names='Vehicle_Type',
                          title="Advertising Expenditure for vehicle type during recessions"
                          )
        )
